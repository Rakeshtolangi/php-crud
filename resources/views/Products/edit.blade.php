        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <form action="{{ route('product.update', $product->id) }}" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" name="qty" value="{{ $product->qty }}" placeholder="qty"
                            class="form-control" id="floatingQty">
                        <label for="floatingQty">Quantity</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="number" step="0.01" name="price" value="{{ $product->price }}" placeholder="price"
                            class="form-control" id="floatingPrice">
                        <label for="floatingPrice">Price</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" name="description" value="{{ $product->description }}"
                            placeholder="Description" class="form-control" id="floatingDescription">
